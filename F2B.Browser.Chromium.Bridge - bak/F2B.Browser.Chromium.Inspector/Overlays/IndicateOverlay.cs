...
{
    internal sealed class IndicateOverlay : Window
    {
        ...
        private void EnableClickThrough()
        {
            ...
            WindowStyleHelper.SetExtendedStyle(hwnd, wsExTransparent | wsExNoActivate | wsExToolWindow);
        }
        ...
        private static class WindowStyleHelper
        {
            ...
            public static void SetExtendedStyle(IntPtr hwnd, int flags)
            {
                ...
                var updated = new IntPtr(style.ToInt64() | (long)(uint)flags);

                if (IntPtr.Size == 8)
                    SetWindowLongPtr64(hwnd, GwlExstyle, updated);
                else
