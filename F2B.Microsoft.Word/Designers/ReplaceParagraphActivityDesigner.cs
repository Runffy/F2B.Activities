...
{
    public sealed class ReplaceParagraphActivityDesigner : ActivityDesigner
    {
        private const string LabelColumn = "WordReplaceParagraphLabelColumn";
        ...
        public ReplaceParagraphActivityDesigner()
        {
