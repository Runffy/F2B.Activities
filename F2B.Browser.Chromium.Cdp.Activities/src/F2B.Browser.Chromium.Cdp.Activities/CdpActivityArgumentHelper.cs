...
{
    internal static class CdpActivityArgumentHelper
    {
        ...
        public static CdpElement GetCdpElement(InArgument<CdpElement> argument, CodeActivityContext context)
        {
            ...
            return AsCdpElement(ResolveWorkflowVariable(context, variableName));
        }

        public static void SetCdpElement(OutArgument<CdpElement> argument, ActivityContext context, CdpElement value)
        {
        ...
        public static CdpElement AsCdpElement(object value)
        {
            if (value == null)
            {
                return null;
            ...
            if (value is CdpElement element)
            {
                return element;
            }

            throw new ArgumentException(
                "Expected " + typeof(CdpElement).FullName + ", but received " + value.GetType().FullName + ".");
        }
