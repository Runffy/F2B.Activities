...
{
    [DisplayName("Uncheck")]
    [Description("Uncheck target checkbox/radio element.")]
    public sealed class UncheckElementActivity : IeElementActivityBase
    {
        [Category("Input")]
        ...
        {
            ResolveWindow(context).uncheck_element(
