...
{
    [DisplayName("Click")]
    [Description("Perform native click on target element.")]
    public sealed class ClickElementNativeActivity : IeElementActivityBase
    {
        [Category("Time")]
        ...
        {
            ResolveWindow(context).click_element_native(
