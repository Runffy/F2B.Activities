...
{
    /// <summary>
    /// Shows only <strong>Credential name</strong> on the activity canvas; Username, Password, and Secure password are edited in the property grid.
    /// </summary>
    public sealed class GetWindowsCredentialDesigner : ActivityDesigner
    {
        private readonly Border _credentialNameEditorBorder;
        private readonly ExpressionTextBox _credentialNameExpressionBox;

        public GetWindowsCredentialDesigner()
        {
        ...
        private void RefreshRequiredBorders()
        {
            SetRequiredBorder(
                ...
                IsArgumentFilled(ModelItem, "CredentialName", _credentialNameExpressionBox));
        }
